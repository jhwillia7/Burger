...
INSERT INTO `burgers_db`.`burgers` (`burger_name`) VALUES ('Grass Fed Bacon Mushroom Swiss Burger');
INSERT INTO `burgers_db`.`burgers` (`burger_name`) VALUES ('Hickory Smoked Chicken Thigh Siracha Burger');
INSERT INTO `burgers_db`.`burgers` (`burger_name`) VALUES ('Pretzel Bun Sweet Teriyaki Burger');
